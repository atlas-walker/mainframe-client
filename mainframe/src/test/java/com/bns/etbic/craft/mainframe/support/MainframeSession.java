...
/**
 * Sesión de mainframe con alcance de UN escenario.
 *
 ...
 * <ul>
 *   <li>ser 100% mainframe: abre la sesión en su primer step y la reúsa;</li>
 *   <li>ser mayormente Playwright y tocar el mainframe en un solo step: conecta
 *       solo en ese step;</li>
 *   <li>no tocar el mainframe: no abre ninguna conexión.</li>
 * </ul>
 *
 ...
 */
public final class MainframeSession implements AutoCloseable {

    private MainframeDriver driver;

    /** Conecta la primera vez que se llama; reutiliza la conexión después. */
    public MainframeDriver driver() {
        if (driver == null) {
            MainframeDriver d = MainframeDriver.builder()
                .host(MainframeConfig.host()).port(23)
                .codePage("37")
                .deviceName(MainframeConfig.deviceName())
                .headless(true)
